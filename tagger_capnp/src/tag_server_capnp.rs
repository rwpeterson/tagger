...
pub mod input_settings {
  pub use self::Which::{Inversionmask,Delay,Threshold};
  ...
  impl <'a,> Reader<'a,>  {
    ...
    pub fn which(self) -> ::core::result::Result<WhichReader<'a,>, ::capnp::NotInSchema> {
      match self.reader.get_data_field::<u16>(1) {
        0 => {
          ::core::result::Result::Ok(Inversionmask(
  ...
  pub type WhichReader<'a,> = Which<::capnp::Result<crate::tag_server_capnp::channel_delay::Reader<'a>>,::capnp::Result<crate::tag_server_capnp::channel_threshold::Reader<'a>>>;
  pub type WhichBuilder<'a,> = Which<::capnp::Result<crate::tag_server_capnp::channel_delay::Builder<'a>>,::capnp::Result<crate::tag_server_capnp::channel_threshold::Builder<'a>>>;
}
...
pub mod service_sub {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_patmasks(self) -> ::capnp::Result<::capnp::primitive_list::Reader<'a,u16>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0), ::core::option::Option::None)
    }
    pub fn has_patmasks(&self) -> bool {
      !self.reader.get_pointer_field(0).is_null()
    }
  }
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_patmasks(self) -> ::capnp::Result<::capnp::primitive_list::Builder<'a,u16>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_patmasks(&mut self, value: ::capnp::primitive_list::Reader<'a,u16>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_patmasks(self, size: u32) -> ::capnp::primitive_list::Builder<'a,u16> {
      ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0), size)
    }
    pub fn has_patmasks(&self) -> bool {
      !self.builder.get_pointer_field(0).is_null()
